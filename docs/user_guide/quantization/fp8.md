...
For ModelOpt-produced pre-quantized checkpoints, see[ModelOpt Quantization](Omni/vllm-omni-m/docs/user_guide/quantization/modelopt.md)).
...
|-------|-------|--------|--------|
| Qwen3-Omni | Thinker language-model stage |[ModelOpt](Omni/vllm-omni-m/docs/user_guide/quantization/modelopt.md)) `quant_algo=FP8` | Tested for thinker memory reduction |
